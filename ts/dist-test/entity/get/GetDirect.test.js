...
(0, node_test_1.describe)('GetDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.CrowdSourcedLyricsSDK({
    ...
    (0, node_test_1.test)('direct-load-get', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.CrowdSourcedLyricsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['CROWD_SOURCED_LYRICS_TEST_GET_ENTID'];
    ...
    const client = new __1.CrowdSourcedLyricsSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetDirect.test.js.map