...
function envOverride(m) {
    if ('TRUE' === process.env.CROWD_SOURCED_LYRICS_TEST_LIVE ||
        'TRUE' === process.env.CROWD_SOURCED_LYRICS_TEST_OVERRIDE) {
    ...
    m.CROWD_SOURCED_LYRICS_TEST_EXPLAIN = process.env.CROWD_SOURCED_LYRICS_TEST_EXPLAIN || m.CROWD_SOURCED_LYRICS_TEST_EXPLAIN;
    return m;
}
