...
AQL-driven CLI and REPL for the CrowdSourcedLyrics SDK. Positional arguments are
...
```sh
go build -o crowd-sourced-lyrics-cli ./...
```
...
./crowd-sourced-lyrics-cli list get
./crowd-sourced-lyrics-cli load 1 get
./crowd-sourced-lyrics-cli load '{id:1}' get
