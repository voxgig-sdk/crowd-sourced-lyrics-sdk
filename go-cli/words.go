...
func registerSDKWords(r *eng.Registry, client *sdk.CrowdSourcedLyricsSDK) {
...
func runOp(client *sdk.CrowdSourcedLyricsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
