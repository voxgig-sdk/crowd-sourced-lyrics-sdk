...
#      offline in seeded test mode (CrowdSourcedLyricsSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "CrowdSourcedLyrics_sdk.rb")
  SDK_CLASS = "CrowdSourcedLyricsSDK"
  ...
  SDK_BASE = "CrowdSourcedLyrics_sdk"
