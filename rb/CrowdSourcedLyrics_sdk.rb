...
require_relative 'CrowdSourcedLyrics_types'
...
class CrowdSourcedLyricsSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = CrowdSourcedLyricsHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = CrowdSourcedLyricsHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, CrowdSourcedLyricsFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    CrowdSourcedLyricsUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = CrowdSourcedLyricsHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = CrowdSourcedLyricsHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = CrowdSourcedLyricsHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def op_denied(op)
    ...
    {
      "ok" => false,
      "err" => CrowdSourcedLyricsError.new(
        "#{op}_allow",
  ...
  def raw_request(fetchargs = {})
    ...
    rescue CrowdSourcedLyricsError => err
    ...
    if fetched.is_a?(Hash)
      status = CrowdSourcedLyricsHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = CrowdSourcedLyricsError.new(
        "graphql_error", "CrowdSourcedLyricsSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = CrowdSourcedLyricsSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
