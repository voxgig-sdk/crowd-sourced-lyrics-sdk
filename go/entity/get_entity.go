...
type GetEntity struct {
	name    string
	client  *core.CrowdSourcedLyricsSDK
...
func NewGetEntity(client *core.CrowdSourcedLyricsSDK, entopts map[string]any) *GetEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetEntity) GetName() string { return e.name }
...
func (e *GetEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetEntity) Deleted() bool {
	return e.deleted
}


func (e *GetEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetEntity(e.client, opts)
}

func (e *GetEntity) Data(args ...any) any {
...
func (e *GetEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Get; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetEntity) DataTyped(data ...Get) Get {
	if len(data) > 0 {
		return typedFrom[Get](e.Data(asMap(data[0])))
	}
	return typedFrom[Get](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Get (all fields
// optional at the wire level).
func (e *GetEntity) MatchTyped(match ...Get) Get {
	if len(match) > 0 {
		return typedFrom[Get](e.Match(asMap(match[0])))
	}
	return typedFrom[Get](e.Match())
}
...
func (e *GetEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetLoadMatch and returns an Get. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GetEntity) LoadTyped(reqmatch GetLoadMatch, ctrl map[string]any) (Get, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Get{}, err
	}
	return typedFrom[Get](res), nil
}



func (e *GetEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GetEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
