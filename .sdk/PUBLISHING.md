...
|---|---|---|
| `ts/` | @voxgig-sdk/crowd-sourced-lyrics-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/crowd-sourced-lyrics-sdk \
      --repository voxgig-sdk/crowd-sourced-lyrics-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/crowd-sourced-lyrics-sdk` shows it, and
`npm trust revoke @voxgig-sdk/crowd-sourced-lyrics-sdk --id=<id>` removes it.
