...
// CrowdSourcedLyrics SDK utility type

class CrowdSourcedLyricsUtility
{
    ...
    public static function copy(CrowdSourcedLyricsUtility $src): CrowdSourcedLyricsUtility
    {
        $u = new CrowdSourcedLyricsUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
