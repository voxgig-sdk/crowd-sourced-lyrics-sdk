...
// CrowdSourcedLyrics SDK utility: result_basic

class CrowdSourcedLyricsResultBasic
{
    public static function call(CrowdSourcedLyricsContext $ctx): ?CrowdSourcedLyricsResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof CrowdSourcedLyricsError) ? $result->err->msg : (string)$result->err;
