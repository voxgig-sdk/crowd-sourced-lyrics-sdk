...
// CrowdSourcedLyrics SDK proxy feature
...
class CrowdSourcedLyricsProxyFeature extends CrowdSourcedLyricsBaseFeature
{
    ...
    public function init(CrowdSourcedLyricsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CrowdSourcedLyricsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
