...
// CrowdSourcedLyrics SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class CrowdSourcedLyricsTestFeature extends CrowdSourcedLyricsBaseFeature
{
    ...
    public function init(CrowdSourcedLyricsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (CrowdSourcedLyricsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = CrowdSourcedLyricsParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (CrowdSourcedLyricsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(CrowdSourcedLyricsContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = CrowdSourcedLyricsParam::call($ctx, $k);
