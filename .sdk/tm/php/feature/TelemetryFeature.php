...
// CrowdSourcedLyrics SDK telemetry feature
...
class CrowdSourcedLyricsTelemetryFeature extends CrowdSourcedLyricsBaseFeature
{
    ...
    private function _close(CrowdSourcedLyricsContext $ctx, bool $ok): void
    {
