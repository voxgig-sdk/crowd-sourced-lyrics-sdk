...
// CrowdSourcedLyrics SDK metrics feature
...
class CrowdSourcedLyricsMetricsFeature extends CrowdSourcedLyricsBaseFeature
{
    ...
    private function _record(CrowdSourcedLyricsContext $ctx, bool $ok): void
    {
