...
// CrowdSourcedLyrics SDK idempotency feature
...
class CrowdSourcedLyricsIdempotencyFeature extends CrowdSourcedLyricsBaseFeature
{
    ...
    private function _mutating(CrowdSourcedLyricsContext $ctx): bool
    {
