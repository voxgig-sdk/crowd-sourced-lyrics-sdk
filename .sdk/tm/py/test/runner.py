...
class CrowdSourcedLyricsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CrowdSourcedLyricsTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = CrowdSourcedLyricsTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = CrowdSourcedLyricsTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
