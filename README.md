...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/crowd-sourced-lyrics` | `npm install @voxgig-sdk/crowd-sourced-lyrics` |
| Python | `voxgig-sdk-crowd-sourced-lyrics` | `pip install voxgig-sdk-crowd-sourced-lyrics` |
| PHP | `voxgig-sdk/crowd-sourced-lyrics` | `composer require voxgig-sdk/crowd-sourced-lyrics` |
| Golang | `github.com/voxgig-sdk/crowd-sourced-lyrics-sdk/go` | `go get github.com/voxgig-sdk/crowd-sourced-lyrics-sdk/go` |
| Ruby | `voxgig-sdk-crowd-sourced-lyrics` | `gem install voxgig-sdk-crowd-sourced-lyrics` |
| Lua | `voxgig-sdk-crowd-sourced-lyrics` | `luarocks install voxgig-sdk-crowd-sourced-lyrics` |
