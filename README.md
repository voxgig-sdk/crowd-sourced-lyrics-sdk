...
Crowd Sourced Lyrics API - A community-driven API for accessing synchronized lyrics (LRC format) for songs

Learn more about Crowd Sourced Lyrics API at [lrclib.net](https://lrclib.net).
...
| Go CLI | `github.com/voxgig-sdk/crowd-sourced-lyrics-sdk/go-cli` | `go install github.com/voxgig-sdk/crowd-sourced-lyrics-sdk/go-cli/cmd/crowd-sourced-lyrics@latest` |
| Go MCP server | `github.com/voxgig-sdk/crowd-sourced-lyrics-sdk/go-mcp` | `go get github.com/voxgig-sdk/crowd-sourced-lyrics-sdk/go-mcp@latest` |
