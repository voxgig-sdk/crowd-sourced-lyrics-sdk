...
local function make_error_util(ctx, err)
  ...
  local msg = "CrowdSourcedLyricsSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = CrowdSourcedLyricsError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == CrowdSourcedLyricsError then
