...
function runner.env_override(m)
  local live = runner.getenv("CROWDSOURCEDLYRICS_TEST_LIVE")
  local override = runner.getenv("CROWDSOURCEDLYRICS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CROWDSOURCEDLYRICS_TEST_EXPLAIN")
