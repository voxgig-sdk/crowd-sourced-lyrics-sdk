...
function runner.env_override(m)
  local live = runner.getenv("CROWD_SOURCED_LYRICS_TEST_LIVE")
  local override = runner.getenv("CROWD_SOURCED_LYRICS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CROWD_SOURCED_LYRICS_TEST_EXPLAIN")
