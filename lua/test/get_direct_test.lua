...
describe("GetDirect", function()
  it("should direct-load-get", function()
    local setup = get_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get", setup.live and "live" or "unit")
