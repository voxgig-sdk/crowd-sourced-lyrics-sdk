// Command CrowdSourcedLyrics-mcp is an MCP server exposing the CrowdSourcedLyrics
// SDK as MCP tools.
//
// Two tools are registered:
//
//	CrowdSourcedLyrics_list  — list records of an entity
//	CrowdSourcedLyrics_load  — load a single record of an entity
//
