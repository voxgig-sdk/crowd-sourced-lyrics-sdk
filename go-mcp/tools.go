...
type Args struct {
	Entity string         `json:"entity" jsonschema:"get"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.CrowdSourcedLyricsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "crowd-sourced-lyrics_list",
		Description: "List records from CrowdSourcedLyrics. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "crowd-sourced-lyrics_load",
		Description: "Load a single record from CrowdSourcedLyrics. " +
...
func runOp(client *sdk.CrowdSourcedLyricsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.CrowdSourcedLyricsSDK, name string) (sdk.CrowdSourcedLyricsEntity, error) {
	switch strings.ToLower(name) {
	case "get":
		return client.Get(nil), nil
