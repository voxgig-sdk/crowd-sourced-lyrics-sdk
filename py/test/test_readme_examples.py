# CrowdSourcedLyrics SDK — root README python-examples test.
#
...
def test_readme_python_blocks_typecheck():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # Resolve "from crowdsourcedlyrics_sdk import CrowdSourcedLyricsSDK" against the package root.
...
def test_readme_testmode_snippets_run():
    ...
    for i, block in enumerate(blocks):
        ...
        namespace = {"CrowdSourcedLyricsSDK": CrowdSourcedLyricsSDK, "os": os}
        try:
