# CrowdSourcedLyrics SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CrowdSourcedLyricsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CrowdSourcedLyricsSDK(...) and CrowdSourcedLyricsSDK.test(...) become
#      CrowdSourcedLyricsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "crowdsourcedlyrics_sdk"
_SDK_CLASS = "CrowdSourcedLyricsSDK"
