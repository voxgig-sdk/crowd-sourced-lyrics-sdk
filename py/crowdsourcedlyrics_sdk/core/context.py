...
from crowdsourcedlyrics_sdk.core.helpers import get_ctx_prop, to_map
...
class CrowdSourcedLyricsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = CrowdSourcedLyricsControl()
        ...
        if isinstance(sp, CrowdSourcedLyricsSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, CrowdSourcedLyricsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, CrowdSourcedLyricsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return CrowdSourcedLyricsOperation({})
    ...
    def make_error(self, code, msg):
        return CrowdSourcedLyricsError(code, msg, self)
