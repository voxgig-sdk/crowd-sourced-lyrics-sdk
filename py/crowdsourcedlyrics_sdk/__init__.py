...
from crowdsourcedlyrics_sdk.utility import register

# Load features
from crowdsourcedlyrics_sdk.feature.base_feature import CrowdSourcedLyricsBaseFeature
from crowdsourcedlyrics_sdk.features import _has_feature, _make_feature
...
class CrowdSourcedLyricsSDK:
    ...
    def get_utility(self):
        return CrowdSourcedLyricsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CrowdSourcedLyricsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Get(self, data=None) -> "GetEntity":
        ...
        from crowdsourcedlyrics_sdk.entity.get_entity import GetEntity
