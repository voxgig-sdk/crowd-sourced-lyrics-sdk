...
// CrowdSourcedLyrics SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class CrowdSourcedLyricsMakeRequest
{
    public static function call(CrowdSourcedLyricsContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new CrowdSourcedLyricsResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new CrowdSourcedLyricsResponse($fetched);
        } else {
