...
// CrowdSourcedLyrics SDK utility: graphql
//
...
class CrowdSourcedLyricsGraphql
{
    ...
    // equivalent.
    public static function body(CrowdSourcedLyricsContext $ctx): mixed
    {
    ...
    public static function errors(CrowdSourcedLyricsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
