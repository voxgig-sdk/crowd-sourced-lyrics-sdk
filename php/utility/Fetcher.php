...
// CrowdSourcedLyrics SDK utility: fetcher

class CrowdSourcedLyricsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CrowdSourcedLyricsSDK/1.0)';
    ...
    public static function call(CrowdSourcedLyricsContext $ctx, string $fullurl, array $fetchdef): array
    {
