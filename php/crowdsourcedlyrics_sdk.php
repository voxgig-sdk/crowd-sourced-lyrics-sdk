...
class CrowdSourcedLyricsSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = CrowdSourcedLyricsHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = CrowdSourcedLyricsHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!CrowdSourcedLyricsFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, CrowdSourcedLyricsFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return CrowdSourcedLyricsUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = CrowdSourcedLyricsHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = CrowdSourcedLyricsHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = CrowdSourcedLyricsHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new CrowdSourcedLyricsError($op . "_allow",
                "CrowdSourcedLyricsSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = CrowdSourcedLyricsHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new CrowdSourcedLyricsError("graphql_error",
                "CrowdSourcedLyricsSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Get($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_get === null) {
                $this->_get = new GetEntity($this, null);
            }
            return $this->_get;
        }
        return new GetEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new CrowdSourcedLyricsSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
