...
// CrowdSourcedLyrics SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CrowdSourcedLyricsSDK::test)
...
{
    private const SDK_CLASS = 'CrowdSourcedLyricsSDK';
    ...
    private const SDK_BASE = 'crowdsourcedlyrics_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../crowdsourcedlyrics_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
