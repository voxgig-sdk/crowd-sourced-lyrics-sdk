...
// CrowdSourcedLyrics SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CrowdSourcedLyricsOmni::makeStructRunner(
    ...
    {
        return CrowdSourcedLyricsOmni::objmodel(CrowdSourcedLyricsOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return CrowdSourcedLyricsOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return CrowdSourcedLyricsOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CrowdSourcedLyricsOmni::structfix($now, Struct::undef()))
                        !== json_encode(CrowdSourcedLyricsOmni::structfix($val, Struct::undef()))) {
