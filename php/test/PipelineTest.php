...
// CrowdSourcedLyrics SDK pipeline test
//
...
{
    private static function utility(): CrowdSourcedLyricsUtility
    {
        return new CrowdSourcedLyricsUtility();
    }
    ...
    private static function ctx(array $over = []): CrowdSourcedLyricsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new CrowdSourcedLyricsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new CrowdSourcedLyricsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof CrowdSourcedLyricsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new CrowdSourcedLyricsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = CrowdSourcedLyricsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new CrowdSourcedLyricsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = CrowdSourcedLyricsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new CrowdSourcedLyricsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = CrowdSourcedLyricsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CrowdSourcedLyricsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = CrowdSourcedLyricsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new CrowdSourcedLyricsResponse([]),
            'result' => new CrowdSourcedLyricsResult([]),
        ]);
        [, $err] = CrowdSourcedLyricsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new CrowdSourcedLyricsSpec([]),
            'response' => null,
            'result' => new CrowdSourcedLyricsResult([]),
        ]);
        [, $err] = CrowdSourcedLyricsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new CrowdSourcedLyricsSpec(['step' => 's']),
            'response' => new CrowdSourcedLyricsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new CrowdSourcedLyricsResult([]),
        ]);
        [, $err] = CrowdSourcedLyricsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new CrowdSourcedLyricsSpec(['step' => 's']),
            'response' => new CrowdSourcedLyricsResponse(self::resp(200, ['v' => 1])),
            'result' => new CrowdSourcedLyricsResult([]),
        ]);
        [, $err] = CrowdSourcedLyricsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new CrowdSourcedLyricsSpec(['step' => 's']),
            'response' => new CrowdSourcedLyricsResponse(self::resp(200, ['v' => 2])),
            'result' => new CrowdSourcedLyricsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        CrowdSourcedLyricsMakeResponse::call($ctx);
    ...
    {
        $preset = new CrowdSourcedLyricsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new CrowdSourcedLyricsSpec([]),
            'response' => new CrowdSourcedLyricsResponse([]),
            'result' => new CrowdSourcedLyricsResult([]),
        ...
        [$got, $err] = CrowdSourcedLyricsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new CrowdSourcedLyricsResult([])]);
        [, $err] = CrowdSourcedLyricsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new CrowdSourcedLyricsSpec([]), 'result' => null]);
        [, $err] = CrowdSourcedLyricsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CrowdSourcedLyricsSpec(['step' => 's']),
            'result' => new CrowdSourcedLyricsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new CrowdSourcedLyricsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CrowdSourcedLyricsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CrowdSourcedLyricsSpec(['step' => 's']),
            'result' => new CrowdSourcedLyricsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new CrowdSourcedLyricsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CrowdSourcedLyricsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CrowdSourcedLyricsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new CrowdSourcedLyricsSpec([]),
            'result' => new CrowdSourcedLyricsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = CrowdSourcedLyricsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CrowdSourcedLyricsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new CrowdSourcedLyricsError('boom', 'boom');
        $utility->fetcher = function (CrowdSourcedLyricsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CrowdSourcedLyricsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = CrowdSourcedLyricsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (CrowdSourcedLyricsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = CrowdSourcedLyricsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(CrowdSourcedLyricsResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        CrowdSourcedLyricsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (CrowdSourcedLyricsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CrowdSourcedLyricsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = CrowdSourcedLyricsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new CrowdSourcedLyricsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new CrowdSourcedLyricsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = CrowdSourcedLyricsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = CrowdSourcedLyricsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = CrowdSourcedLyricsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new CrowdSourcedLyricsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, CrowdSourcedLyricsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new CrowdSourcedLyricsResult(['ok' => false])]);
        $this->expectException(CrowdSourcedLyricsError::class);
        CrowdSourcedLyricsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new CrowdSourcedLyricsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', CrowdSourcedLyricsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        CrowdSourcedLyricsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new CrowdSourcedLyricsBaseFeature();
        $b = new CrowdSourcedLyricsBaseFeature();
        CrowdSourcedLyricsFeatureAdd::call($ctx, $a);
        CrowdSourcedLyricsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): CrowdSourcedLyricsBaseFeature
    {
        $f = new CrowdSourcedLyricsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        CrowdSourcedLyricsFeatureAdd::call($ctx, self::named_feature('a'));
        CrowdSourcedLyricsFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        CrowdSourcedLyricsFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        CrowdSourcedLyricsFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        CrowdSourcedLyricsFeatureAdd::call($ctx, $replace);
        ...
        CrowdSourcedLyricsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): CrowdSourcedLyricsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new CrowdSourcedLyricsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CrowdSourcedLyricsPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        CrowdSourcedLyricsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new CrowdSourcedLyricsResponse(['headers' => null]),
            'result' => new CrowdSourcedLyricsResult([]),
        ]);
        CrowdSourcedLyricsResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        CrowdSourcedLyricsResultBody::call($ctx);
