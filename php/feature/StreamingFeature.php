...
// CrowdSourcedLyrics SDK streaming feature
...
class CrowdSourcedLyricsStreamingFeature extends CrowdSourcedLyricsBaseFeature
{
    ...
    private function _iterate(CrowdSourcedLyricsResult $result): \Generator
    {
    ...
    private function _streamable(CrowdSourcedLyricsContext $ctx): bool
    {
