...
// CrowdSourcedLyrics SDK cache feature
...
class CrowdSourcedLyricsCacheFeature extends CrowdSourcedLyricsBaseFeature
{
    ...
    private function _through(CrowdSourcedLyricsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
