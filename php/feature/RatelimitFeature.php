...
// CrowdSourcedLyrics SDK ratelimit feature
...
class CrowdSourcedLyricsRatelimitFeature extends CrowdSourcedLyricsBaseFeature
{
    ...
    private function _acquire(CrowdSourcedLyricsContext $ctx): void
    {
    ...
    private function _track(CrowdSourcedLyricsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
