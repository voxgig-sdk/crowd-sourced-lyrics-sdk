...
// CrowdSourcedLyrics SDK audit feature
...
class CrowdSourcedLyricsAuditFeature extends CrowdSourcedLyricsBaseFeature
{
    ...
    private function _emit(CrowdSourcedLyricsContext $ctx, string $outcome): void
    {
