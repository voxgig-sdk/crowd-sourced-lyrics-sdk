...
// CrowdSourcedLyrics SDK netsim feature
...
class CrowdSourcedLyricsNetsimFeature extends CrowdSourcedLyricsBaseFeature
{
    ...
    private function _simulate(CrowdSourcedLyricsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CrowdSourcedLyricsContext $ctx, array $applied): void
    {
        $client = $this->client;
