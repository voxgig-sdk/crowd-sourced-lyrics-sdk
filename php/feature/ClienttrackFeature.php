...
// CrowdSourcedLyrics SDK clienttrack feature
...
class CrowdSourcedLyricsClienttrackFeature extends CrowdSourcedLyricsBaseFeature
{
    ...
    public function PostConstruct(CrowdSourcedLyricsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'CrowdSourcedLyrics-SDK';
