...
// CrowdSourcedLyrics SDK rbac feature
...
class CrowdSourcedLyricsRbacFeature extends CrowdSourcedLyricsBaseFeature
{
    ...
    private function _required(CrowdSourcedLyricsContext $ctx): ?string
    {
    ...
    private function _reject(CrowdSourcedLyricsContext $ctx, string $required): void
    {
    ...
    private function _track(CrowdSourcedLyricsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
