...
// CrowdSourcedLyrics SDK timeout feature
...
class CrowdSourcedLyricsTimeoutFeature extends CrowdSourcedLyricsBaseFeature
{
    ...
    private function _with_timeout(CrowdSourcedLyricsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CrowdSourcedLyricsContext $_ctx, float $ms): void
    {
        $client = $this->client;
